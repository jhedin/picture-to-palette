...
vi.mock("../lib/mean-shift.worker", () => ({
  DEFAULT_OPTIONS: { segmentSize: 1500, segBandwidthCap: 0.10, mergeBandwidth: 0.08, minSegmentFrac: 0, excludeBorder: false, subtractBackground: false, kuwahara: false, mergeL: 1.0 },
